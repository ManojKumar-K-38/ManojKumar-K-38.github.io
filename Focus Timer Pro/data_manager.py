...
class DataManager:
    ...
    def get_daily_stats(self, date: datetime = None) -> Dict[str, Any]:
        ...
        total_focus_time = sum(s['duration'] for s in focus_sessions) // 60  # in minutes
        total_break_time = sum(s['duration'] for s in break_sessions) // 60  # in minutes
    ...
    def import_data(self, data: Dict[str, Any]):
        ...
        if 'sessions' in data:
            ...
            # Remove duplicates based on start_time and session_type
            seen = set()
            unique_sessions = []
